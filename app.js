...
// let texto = prompt("digite um numero")

// if (texto > 0) {
//   if (texto % 2 == 0) {
//     alert("numero e positivo e par")
...
// } else if (texto < 0) {
//   if(texto % 2 != 0){
//     alert ("este numero e negativo e impar")
//   } else {
//     alert("este numero negativo e par")
//   }

// } else {
//   alert("este numero e zero")
// }
...
//   }
// }
// //se tentativa for maior que 1 palavra no plural, SENÃO palavra no singular.
...
//DESAFIO:
//criar cards usando HTML e CSS, e usar a lista de pokemons para adicionaros cards dinamicamente usando JS
...
document.addEventListener("DOMContentLoaded", function () {
  pokemons.forEach((pokemon) => {
    ...
    pokemon.type.forEach((type) => {
      ...
      h3.innerHTML = type;
      divType.appendChild(h3);
      types.push(type.toLowerCase());
    });

    divCard.style.background =
      types.length == 2
        ? `linear-gradient(to left, ${pokemonColors[types[0]]}, ${
            pokemonColors[types[1]]
          })`
        : `linear-gradient(to left, ${pokemonColors[types[0]]}, ${
            pokemonColors[types[0]]
          })`;
